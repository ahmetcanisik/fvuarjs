...
class Fvuar {
    ...
    static alert({ theme, position, text, time, css, clickToClose }) {
        try {
    ...
    static new({ theme = Defines.CONFIG.DEFAULTTHEME, position = Defines.CONFIG.DEFAULTPOSITION, text, time = Defines.CONFIG.DEFAULTTIME, css = null, clickToClose = Defines.CONFIG.CLICKTOCLOSE }) {
        ...
        Fvuar.alert({ theme, position, text, time, css, clickToClose });
    }
}
