...
```javascript
<script src="https://cdn.jsdelivr.net/npm/fvuarjs@1.4/fvuar.min.js"></script>
```
...
<html lang="en">
    <head>
        <!-- ... -->
        <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/fvuarjs@1.4/fvuar.min.js"></script>
    </head>
    <body>
