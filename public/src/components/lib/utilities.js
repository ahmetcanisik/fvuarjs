...
export const cl = content[preferences.lang];
...
document.querySelector('title').innerText = cl.header.title;

export function updatePreferences({ lang, theme, colors }) {
    let pref = {
...
export function Icon({ icon }) {
    ...
    switch (icon) {
        case 'preferences':
            svg = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24"
