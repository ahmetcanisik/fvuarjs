    ...
    return (
        <hgroup>
            ...
            <a href='/' className='logo-text'>
                ...
                <span className="mini-logo">{stored.cl.header.select_language.slogan}</span>
            </a>
        </hgroup>
    );
}
...
function NavBar() {
    return (
        <nav>
            <ul className='navbar'>
                <li><a href='/test' className='btn'>test</a></li>
                <li><a href='/update-notes' className='btn'>notes</a></li>
            </ul>
        </nav>
    );
}
